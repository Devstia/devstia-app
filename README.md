...
#### 2) Next, run the build script for your platform, i.e. for building macOS on Apple Silicon (M1, M2, and M3 processors): (see the *Signing* section below).
...
The resulting executable can be found for your architecture and platform in the resulting `build/dist` folder. 
